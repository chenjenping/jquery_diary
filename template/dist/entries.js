function pug_escape(e){
  ...
  if ('number' == typeof $$obj.length) {
      for (var pug_index0 = 0; pug_index0 < $$obj.length; pug_index0++) {
        ...
        pug_html = pug_html + "\u003Cdiv class=\"entry\"\u003E\u003Cdiv class=\"time\"\u003E" + (pug_escape(null == (pug_interp = formatTime(new Date(entry.created_at))) ? "" : pug_interp)) + "\u003Cbutton class=\"btn_del\" id=\"btn" + $$l + "\" name=\"btn" + $$l + "\" \u003EX\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003Cpre class=\"content\"\u003E" + 
